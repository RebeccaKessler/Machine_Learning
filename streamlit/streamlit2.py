...
if display_button or 'init' not in st.session_stat:
    display_library("title" if filter_type == "Title" else "prediction" if filter_type == "Prediction Level", filter_value)
