...
To set up these models, we went through the following steps. Step 1 - 6 are thereby performed exclusively on the labelled training data which was furhter split into trainig and test data (80/20), with the training data reserved to find the best parameters and the test data to evaluate the final model. 
