...
To set up these models, we went through the following steps. Step 1 - 6 are thereby performed exclusively on the training data and serve to fine-tune the models. 
