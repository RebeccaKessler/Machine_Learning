...
- **Step 7: Optimization:**
To increase the performance (i.e. accuracy) of the model we set up a hyper-optimization process using Optina. This helped us find a good combination of parameters (epochs, batch size, and learning rate) which we then further adjusted manually until we were satisfied with the performance level of the model.
- **Step 8: Prediction:**
